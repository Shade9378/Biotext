<template>
    <!--
        This "Element3Narrow.vue" component shows up when the screen is narrower than a certain number.
        (See "ScrollView.vue")
    -->
    <!--
    ...
    ​                </h6>
            ...
            <div class="page" id="page">
                <img src="@/assets/Unit1-ScreenshotOfTwoPeopleSharingSoda.png" style="width:20%; float:right; margin-right:1%">
                <p>
                ...
                <img src="@/assets/Unit1-ScreenshotOfTwoPeopleSharingSoda2.png" style="width:100px; float:right; margin-right:1%">
...
import '@/assets/narrow-style.css'
export default{
    data(){
        return{
            count: 0,
